...
const MyplanePage = () => {
    return (
        <div className='container mx-auto '>
            <h2 className='text-[30px ] font-bold text-[#FFFFFF]'>MY PLAN</h2>
            <p className='text-[14px] text-[#8A92A0] mb-8' >Cap of five lifts for today. Finish them, then load more.</p>
